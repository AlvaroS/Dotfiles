--[[
    ...
    AlvaroS AwesomeWM configuration based on Awesome-copycats by lcpz

    https://github.com/AlvaroS
    https://github.com/lcpz
...
globalkeys = mytable.join(
	...
	awful.key({}, "XF86MonBrightnessDown", function()
		os.execute("brightnessctl setUp 5%-")
	end, { description = "-10%", group = "hotkeys" }),
	...
	awful.key({ modkey }, "d", function()
		os.execute(string.format("rofi -show run", "run", "dmenu"))
